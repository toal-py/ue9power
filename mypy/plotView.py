...
def plotMonthlyShare(data):
    ...
    sns.barplot(data = dframe, x = 'red', y = 'orange', hue = 'orange', orient = 'h', palette = ['tab:orange'])       
    sns.barplot(data = dframe, x = 'red', y = 'green', hue = 'green', orient = 'h', palette = ['tab:green'])      
    plotFile = BytesIO()    
    plotFigure.savefig(plotFile, format='png')
    plotFile.seek(0)
    encodedFile = base64.b64encode(plotFile.getbuffer())
